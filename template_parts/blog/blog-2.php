...
<ul class="font-pop space-y-8">
  ...
  ?>
      <li class="lg:max-w-[50rem] border-b flex items-center">
        <?php if ($first_img) : ?>
          <a class="block" href="<?php echo $post_link; ?>" style="flex: 1;">
            <img class="w-56 h-56 object-cover" src="<?php echo $first_img; ?>" alt="<?php echo $post_title; ?>">
          </a>
        <?php endif; ?>

        <div class="my-4 space-y-6" style="flex: 2;">
          <a class="text-xl line-clamp-1 hover:text-[#ed1f84] hover:underline hover:decoration-wavy" href="<?php echo $post_link; ?>">
            <?php echo $post_title; ?>
          </a>
