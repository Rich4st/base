...
?>
<ul class="font-pop grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 px-4">
  <?php
  ...
  ?>
      <li class="lg:max-w-[40rem] border-b md:border-none">
        <?php if ($first_img) : ?>
        ...
        <div class="my-4 space-y-6">
          ...
          <p class="w-full line-clamp-2 min-h-12">
...
<ul class="pagination flex items-center space-x-4 px-4">
  <li>
    <?php
    // 分页链接
