...
<div>
  <div class="flex items-center justify-between lg:max-w-2xl lg:mx-auto">
    <div class="flex items-center justify-center">
      <img class="w-12 h-12 rounded-full" src="<?php echo get_avatar_url(get_the_author_meta('ID')); ?>" alt="">
      <div class="ml-4">
